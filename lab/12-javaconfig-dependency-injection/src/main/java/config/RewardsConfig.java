 ...
 * - Use an appropriate annotation. @Configuration
 *
...
public class RewardsConfig {
	...
	JdbcRestaurantRepository jdbcRestaurantRepository;
	JdbcRewardRepository jdbcRewardRepository;
	...
	RestaurantRepository restaurantRepository() {
		jdbcRestaurantRepository = new JdbcRestaurantRepository();
	...
	RewardRepository rewardRepository() {
		jdbcRewardRepository = new JdbcRewardRepository();
	...
	RewardNetwork rewardNetwork() {
		return new RewardNetworkImpl(jdbcAccountRepository, jdbcRestaurantRepository, jdbcRewardRepository);
	}
}
