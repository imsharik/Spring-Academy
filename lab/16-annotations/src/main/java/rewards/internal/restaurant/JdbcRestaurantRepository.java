 ...
 *   ---------ANswer-------------------
 *   
 *   the default constructor is now used by Spring instead of the alternate constructor. 
 *   This means the populateRestaurantCache() is never called. 
 *   Moving this method to the default constructor will not address the issue 
 *   as it requires the datasource to be set first. 
 *   Instead, we need to cause populateRestaurantCache() to be executed after 
...
public class JdbcRestaurantRepository implements RestaurantRepository {
	 ...
	 */
	// @PostConstruct annotation to call populateRestaurantCache
